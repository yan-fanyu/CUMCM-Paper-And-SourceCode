...
def f2(x,u1,u2,w1,w2):
    return (1690 * math.cos(1.7152 * x) - 654.3383 * u2 - 8890.7 * u1 + 250000 * (w1 - u1) + 1000 * (w2 - u2) + 1.2 * 4866 * 9.8 * math.sin(u1)) / (11127.20 + 7001.914)

def f3(x,u1,u2,w1,w2):
    return w2

def f4(x,u1,u2,w1,w2):
    return ( - 250000 * (w1 - u1) - 1000 * (w2 - u2))/2000
