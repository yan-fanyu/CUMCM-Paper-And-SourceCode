...
def f2(x,u1,u2,w1,w2,p1,p2,q1,q2):
    return (3640 * math.cos(1.7152 * x) - 683.4558 * u2 -V(u1) * 1025 * 9.8 + 80000 * (w1 - u1) + 10000 * (w2 - u2)-(1-math.cos(p1+q1)) * 9.8 * 2433)*(1/(4866+1028.876))

def f3(x,u1,u2,w1,w2,p1,p2,q1,q2):
    return w2

def f4(x,u1,u2,w1,w2,p1,p2,q1,q2):
    return  (1-math.cos(p1+q1)) * 9.8 - 1 * (1/2433) * (80000 * (w1 - u1) + 10000 * (w2 - u2))

def f5(x,u1,u2,w1,w2,p1,p2,q1,q2):
    return p2

def f6(x,u1,u2,w1,w2,p1,p2,q1,q2):
    return (1690 * math.cos(1.7152 * x) - 654.3383 * p2 - 8890.7 * p1 + 250000 * (q1 - p1) + 1000 * (q2 - p2) - 1.2 * 4866 * 9.8 * math.sin(p1)) / (J1 + 7001.914)

def f7(x,u1,u2,w1,w2,p1,p2,q1,q2):
    return q2

def f8(x,u1,u2,w1,w2,p1,p2,q1,q2):
    return  ((0.25 + 0.2019575 + w1 - u1) * math.sin(p1 + q1) * 9.8 * 2433- 250000 * (q1 - p1) - 1000 * (q2 - p2))/J2(w1,u1)
